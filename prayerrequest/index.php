...
<div class="content">
		...
		<div class="main w3l">
			...
			<form action="index.php" method="post" class="contact-forms wthree">
				<!-- end /.header-->
				...
				<div class="main-row">
					...
					<div class="main-row">
						<div class="input">
							<textarea placeholder="Prayer info" spellcheck="false" name="message"></textarea>
		...
		<p class="copy_rights">&copy; All Rights Reserved | Design by  <a href="https://www.facebook.com/okangbarbara"> Okang Alfred</a></p>
</div>
		<!-- Scripts -->
